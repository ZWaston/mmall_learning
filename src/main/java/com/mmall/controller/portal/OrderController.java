...
public class OrderController {
    ...
    //支付宝回调方法，支付宝会把所有的数据放在HttpServletRequest中，供我们获取
    ...
    public Object alipayCallback(HttpServletRequest request) {
        ...
        for (Iterator iter = requestParams.keySet().iterator(); iter.hasNext();) {
            ...
            params.put(name, valueStr);//此时从request拿到了所有的参数
        }
        ...
        try {
            ...
            if (!alipayRSACheckV2) {
                return ServerResponse.createByErrorMessage("非法请求，验证不通过，恶意请求会被记录");
            }
